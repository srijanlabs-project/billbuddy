...
CREATE TABLE IF NOT EXISTS public.plans (
    ...
    watermark_text text,
    landing_cta_label character varying(80),
...
ALTER TABLE IF EXISTS public.plans
    ADD COLUMN IF NOT EXISTS landing_cta_label character varying(80),
    ADD COLUMN IF NOT EXISTS landing_cta_link text,
    ADD COLUMN IF NOT EXISTS landing_featured boolean DEFAULT false,
    ADD COLUMN IF NOT EXISTS website_visible boolean DEFAULT false,
    ADD COLUMN IF NOT EXISTS website_pointers jsonb DEFAULT '[]'::jsonb;
...
CREATE TABLE IF NOT EXISTS public.platform_footer_banners (
    id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
