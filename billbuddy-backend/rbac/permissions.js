const PERMISSIONS = Object.freeze({
  ...
  APPROVAL_VIEW_OWN: "approval.view_own",
  APPROVAL_VIEW_TEAM: "approval.view_team",
...
const SELLER_ROLE_PERMISSIONS = Object.freeze({
  seller_admin: [
    ...
    PERMISSIONS.APPROVAL_VIEW_TEAM,
...
const PERMISSION_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    title: "Approvals",
    permissions: [
      { key: PERMISSIONS.APPROVAL_REQUEST, label: "Raise approval requests" },
      { key: PERMISSIONS.APPROVAL_VIEW_OWN, label: "View own approval requests" },
      { key: PERMISSIONS.APPROVAL_VIEW_TEAM, label: "View team approval queue" },
      { key: PERMISSIONS.APPROVAL_DECIDE, label: "Approve or reject quotations" },
      { key: PERMISSIONS.APPROVAL_OVERRIDE, label: "Override approval state" }
    ]
  },
  {
