...
export default function SettingsPage({
  ...
  const filteredThemes = Object.entries(QUOTATION_THEME_OPTIONS).filter(([, config]) => config.accessTier === themeLibraryTier);
        ...
        <form className="settings-card compact-settings-card" onSubmit={handleSaveQuotationTemplate}>
          ...
          <div className="settings-plan-banner">
            <div className="settings-plan-banner-copy">
              ...
              <strong>{currentSellerSubscription?.plan_name || currentSellerSubscription?.plan_code || "Demo Plan"}</strong>
              <p>
          ...
          <div className="settings-form-grid settings-form-grid-wide">
            <section className="settings-panel">
              <div className="settings-panel-head">
                <h4>Template and Theme Library</h4>
                <p>Template stays fixed as Default. Use the theme library to preview and choose allowed visual styles.</p>
              </div>
                ...
                <label className="settings-field">
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      if (nextTheme) {
                        applyQuotationThemeSelection(nextTheme);
                      }
                    }}
                  >
              ...
              <label className="settings-field">
                ...
                <select
                  ...
                  onChange={(event) => applyQuotationThemeSelection(event.target.value)}
                >
                ...
                {filteredThemes.map(([key, config]) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => applyQuotationThemeSelection(key)}
                    >
            ...
            <section className="settings-panel">
              <div className="settings-panel-head">
                ...
                <p>The content stays unchanged across themes and appears in the same default layout.</p>
              </div>
              <div className="settings-two-column">
                <label className="settings-field">
            ...
            <section className="settings-panel settings-panel-preview">
              <div className="settings-panel-head">
                <h4>Live Preview</h4>
                <p>Preview any theme on the same default structure before saving.</p>
              </div>

              <div
                className="settings-quotation-preview settings-quotation-preview-themed"
                style={{
